    ...
    <div class="row plus full-img">
        ...
        while ($ob = $res->GetNextElement()) :
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 plus-block products_section">
                ...
                ?><!--/--><? //= $arFields['CODE']
                ?><!--/"-->
                <div class="rakitta-block plus-text collection-header clearfix" style="cursor: pointer;" onclick="window.location.href='/products/<?= $_GET['SECTION_CODE'] ?>/<?= $arFields['CODE'] ?>/';">
                        ...
                        <div class="carousel slide" id="carousel-small-<?= $i ?>" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="/products/<?= $_GET['SECTION_CODE'] ?>/<?= $arFields['CODE'] ?>/">
                ...
                <a href="/products/<?= $_GET['SECTION_CODE'] ?>/<?= $arFields['CODE'] ?>/" class="btn-more"> <span>Подробнее </span>
                    <div></div>
                </a></div>
        <? endwhile ?>
    </div>
